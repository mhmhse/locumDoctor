		...
		<form class="createDemandForm">
			...
			<div class="createDemandFormRowCover">
				...
				<div class="createDemandFormDuration createDemandFormGeneralProperties">
			        ...
			        <div class="createDemandFormRowField">
						<input class="createDemandFormRowFieldOne" type="text" name="TotalHours" placeholder="i.e. 80"></input>
						<p class="createDemandFormRowFieldTwo">Hours</p>
					</div>

					<label class="createDemandFormRow">Is Overtime Applicable?</label>
